...
class Main2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(info.equals("new")){
            val background = BitmapFactory.decodeResource(applicationContext.resources,R.drawable.add_image)
            ...
            val bitmap = chosen.returnChosenImage()
    ...
    fun saveButton(view:View){
        val artName = textView.text.toString()
